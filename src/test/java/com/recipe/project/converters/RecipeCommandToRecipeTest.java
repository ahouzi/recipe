package com.recipe.project.converters;

import com.recipe.project.commands.CategoryCommand;
import com.recipe.project.commands.IngredientCommand;
import com.recipe.project.commands.NotesCommand;
...
public class RecipeCommandToRecipeTest {
    ...
    public void convert() throws Exception {
        ...
        recipeCommand.getIngredientList().add(ingredient);
        recipeCommand.getIngredientList().add(ingredient2);
